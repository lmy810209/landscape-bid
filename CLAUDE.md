...
- **도구 목적 2**: 5년+ 누적 노하우(상위 업체들의 추첨번호 적중률 0.85+)를 1년차가 즉시 활용 → **학습 시간 단축**

도구가 **약속하는 것**:
- 입찰 대행 수수료 절약 (자체 운영 가능)
- 모니터링 자동화 (시도율 ↑)
- 추첨번호 노하우 즉시 활용 (다른 업체 5년치 학습을 데이터로)

도구가 **약속 못 하는 것**:
- 낙찰 보장 (추첨 운에 좌우)
- 단기간에 상위 업체 0.85+ 적중률 도달
...
`simulate-drwt-recommendation.mjs` LOO 결과: 본인 자연 적중률 **0.594 → 추천 따랐을 때 0.781** (+32%).
